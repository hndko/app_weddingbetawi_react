...
export const IntroSection: React.FC = () => {
  return (
    <section className="py-20 px-4 sm:px-6 text-center bg-[#FAF5F5] relative overflow-hidden flex flex-col items-center">
      ...
      <div 
        ...
        style={{
          backgroundImage: `radial-gradient(#7B1122 1.5px, transparent 1.5px)`,
      ...
      <div className="max-w-md mx-auto relative z-10 w-full mb-8">
        ...
        >
          ...
          <div className="text-[#7B1122] mb-4 relative z-10 flex justify-center">
            <svg width="46" height="30" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#7B1122] opacity-90 drop-shadow-xs">
              <circle cx="16" cy="16" r="12" stroke="#7B1122" strokeWidth="2.2" />
              <circle cx="32" cy="16" r="12" stroke="#D4AF37" strokeWidth="2.2" />
              <path d="M16 2 L18 6 L16 8 L14 6 Z" fill="#D4AF37" />
            </svg>
          </div>

          <span className="block text-[11px] tracking-[0.25em] text-[#7B1122] uppercase mb-2 font-serif font-semibold">
          ...
          <h3 className="font-heading text-xl sm:text-2xl text-[#2D080C] mb-4 leading-relaxed font-bold">
            Assalamu'alaikum Warahmatullahi Wabarakatuh
          </h3>

          <p className="text-xs sm:text-[13px] text-[#4A0E13]/85 leading-relaxed mb-4 font-light">
            Dengan memohon rahmat dan ridho Allah Subhanahu Wa Ta'ala, serta restu dari kedua orang tua kami, kami bermaksud mengundang Bapak/Ibu/Saudara/i untuk menghadiri acara pernikahan putra-putri kami:
          </p>
