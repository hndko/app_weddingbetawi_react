...
export const WeddingProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const normalizeConfig = useCallback((data: WeddingConfig): WeddingConfig => {
    return {
      ...
      greeting: { ...defaultConfig.greeting, ...(data.greeting || {}) },
      quote: { ...defaultConfig.quote, ...(data.quote || {}) },
      cover: { ...defaultConfig.cover, ...(data.cover || {}) },
      closing: { ...defaultConfig.closing, ...(data.closing || {}) },
      agencyBranding: { ...defaultConfig.agencyBranding, ...(data.agencyBranding || {}) },
      liveRundown: { ...defaultConfig.liveRundown, ...(data.liveRundown || {}) },
      rundownSchedule: data.rundownSchedule || defaultConfig.rundownSchedule || [],
      physicalGift: { ...defaultConfig.physicalGift, ...(data.physicalGift || {}) },
      streaming: { ...defaultConfig.streaming, ...(data.streaming || {}) },
      whatsappGateway: {
