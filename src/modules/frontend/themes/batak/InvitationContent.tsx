...
// Lazy load Batak cultural sections and shared domain sections
...
export const InvitationContent: React.FC = () => {
  return (
    <>
      <motion.div
        id="scroll-container"
        className="flex-1 h-full overflow-y-auto no-scrollbar scroll-smooth pb-[120px] bg-[#FAF6F0]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        {/* Batak Traditional Top Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#F5ECE0] to-transparent text-[#7A1B1E] select-none">
          <GorgaOrnament variant="medallion" width={40} />
          <span className="text-[10px] tracking-[0.3em] uppercase font-serif mt-1 text-[#7A1B1E] font-bold">
