...
// Lazy load Balinese cultural sections and shared domain sections
...
export const InvitationContent: React.FC = () => {
  return (
    <>
      ...
      >
        {/* Balinese Top Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#F5ECE0] to-transparent text-[#7C2D12] select-none">
          <BungaJepun size={38} />
          <span className="text-[10px] tracking-[0.3em] uppercase font-serif mt-1 text-[#C5A059] font-bold">
            Pawiwahan Adat Bali
          </span>
        </div>
