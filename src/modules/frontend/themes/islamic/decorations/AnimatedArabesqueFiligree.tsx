...
interface AnimatedArabesqueFiligreeProps {
  className?: string;
...
export const AnimatedArabesqueFiligree: React.FC<AnimatedArabesqueFiligreeProps> = ({
  className,
  position = 'top-left',
  size = 68,
  color = '#C5A059',
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Outer Moorish Interlocking Border */}
          <path
          ...
          {/* Arabesque Alhambra Swirling Geometric Tendril */}
          <path
            d="M 18 18 
               C 28 16, 42 22, 46 34 
               C 50 46, 42 54, 32 52 
          ...
          {/* 8-Pointed Star Rosette in Corner */}
          <g transform="translate(16, 16) scale(0.45)">
            <rect x="-8" y="-8" width="16" height="16" fill={color} />
            <rect x="-8" y="-8" width="16" height="16" transform="rotate(45)" fill={color} />
            <circle cx="0" cy="0" r="3" fill="#FAF6EE" />
          </g>

          {/* Golden Finial Drops */}
          <circle cx="48" cy="38" r="2" fill={color} />
          <circle cx="56" cy="48" r="1.8" fill="#0F4C5C" />
