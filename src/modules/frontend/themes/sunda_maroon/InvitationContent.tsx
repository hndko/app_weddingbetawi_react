...
export const InvitationContent: React.FC = () => {
  return (
    <>
      <motion.div
        id="scroll-container"
        className="flex-1 h-full overflow-y-auto no-scrollbar scroll-smooth pb-[120px] bg-[#FAF5F5]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        {/* Sundanese Parahyangan Top Greeting Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#220608] to-transparent text-[#E6D5B8] select-none">
          <MahkotaSiger size={52} color="#D4AF37" accentColor="#7B1122" />
          <span className="text-[10px] tracking-[0.25em] uppercase font-serif mt-1 text-[#E6D5B8]/90">
            The Wedding Celebration • Adat Sunda
          </span>
        </div>
        ...
        <Suspense fallback={<div className="h-[200px] flex items-center justify-center text-[#7B1122]">Memuat data...</div>}>
