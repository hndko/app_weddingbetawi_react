...
// Lazy load Royal cultural sections and shared domain sections
...
export const InvitationContent: React.FC = () => {
  return (
    <>
      <motion.div
        id="scroll-container"
        className="flex-1 h-full overflow-y-auto no-scrollbar scroll-smooth pb-[120px] bg-[#F5E6CA]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        {/* Royal Decree Top Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#EBD5B3] to-transparent text-[#2C1810] select-none font-serif">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#854D0E] font-bold">
        ...
        <Suspense fallback={<div className="h-[200px] flex items-center justify-center font-serif text-[#D4AF37]">Memuat titah kerajaan...</div>}>
