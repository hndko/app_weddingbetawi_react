...
// Lazy load Palembang cultural sections and shared domain sections
...
export const InvitationContent: React.FC = () => {
  return (
    <>
      <motion.div
        id="scroll-container"
        className="flex-1 h-full overflow-y-auto no-scrollbar scroll-smooth pb-[120px] bg-[#FAF5EE]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        {/* Palembang Royal Sriwijaya Top Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#F3E7D5] to-transparent text-[#780016] select-none">
          <MahkotaAesanGede size={46} primaryColor="#780016" goldColor="#D4AF37" accentColor="#FFE082" />
          <span className="text-[10px] tracking-[0.3em] uppercase font-serif mt-1.5 text-[#D4AF37] font-bold">
            Kemegahan Sriwijaya Palembang
          </span>
        </div>
