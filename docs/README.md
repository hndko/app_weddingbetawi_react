...
| [**01-daftar-command.md**](01-daftar-command.md) | **Daftar Perintah CLI & Operasional** | *Developer / DevOps* | Perintah `npm`, migrasi & seeding MySQL, server Express, dev server Vite, kompilasi produksi, testing Vitest & load test Autocannon. |
