...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 py-20 text-center overflow-hidden bg-gradient-to-b from-[#220608] via-[#3D0B0F] to-[#220608] text-[#FAF9F5]">
      {/* Floating Sacred Jasmine & Gold Petals */}
      <FloatingJasmineRonce className="opacity-50" />

      {/* Subtle Golden Pattern Dots Overlay */}
      <div 
      ...
      >
        ...
        >
          <MahkotaSiger size={90} color="#D4AF37" accentColor="#7B1122" />
        </motion.div>
        ...
        <p className="text-[11px] tracking-widest uppercase font-serif text-[#D4AF37]/90 font-light max-w-[300px]">
          Mugia Ginulur Rahayu • Bahagia & Sejahtera Selamanya
        </p>
      </motion.div>
    </section>
  );
