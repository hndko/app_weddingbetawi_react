...
// Lazy load Bugis cultural sections and shared domain sections
...
export const InvitationContent: React.FC = () => {
  return (
    <>
      ...
      >
        {/* Bugis Royal Baruga Top Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#F3ECD8] to-transparent text-[#8B1E1E] select-none">
          <BosaraOrnament size={46} primaryColor="#D4AF37" secondaryColor="#8B1E1E" accentColor="#FFE082" />
          <span className="text-[10px] tracking-[0.3em] uppercase font-serif mt-1.5 text-[#D4AF37] font-bold">
            Baruga Saoraja Bugis-Makassar
          </span>
        </div>
