...
// Lazy load Dayak cultural sections and shared domain sections
...
export const InvitationContent: React.FC = () => {
  return (
    <>
      <motion.div
        id="scroll-container"
        className="flex-1 h-full overflow-y-auto no-scrollbar scroll-smooth pb-[120px] bg-[#FBF8F2]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
      >
        {/* Dayak Kenyah Heritage Top Banner */}
        <div className="pt-6 pb-2 flex flex-col items-center justify-center bg-gradient-to-b from-[#F2ECE1] to-transparent text-[#8B0000] select-none">
          <span className="text-[10px] tracking-[0.3em] uppercase font-serif text-[#8B0000] font-bold">
            • DAYAK KENYAH BORNEO HERITAGE •
          </span>
        </div>
        ...
        <Suspense fallback={<div className="h-[200px] flex items-center justify-center text-[#8B0000]">Memuat data...</div>}>
