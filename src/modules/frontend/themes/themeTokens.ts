...
export const THEME_TOKENS: Record<string, ThemeVisualTokens> = {
  ...
  apple: {
    ...
    floatingBtnRing: 'rgba(0, 113, 227, 0.25)',
    floatingBtnActiveText: '#0071E3',
  },
  ...
  // 🦅 Dayak Kenyah Borneo (Deep Crimson, Borneo Gold & Amber Fire)
  dayak: {
    isDark: false,
    bg: '#FBF8F2',
    cardBg: 'rgba(255, 255, 255, 0.92)',
    ...
    secondary: '#D4AF37',
    accent: '#F59E0B',
    inputBg: 'rgba(251, 248, 242, 0.85)',
    inputBorder: 'rgba(212, 175, 55, 0.35)',
    inputText: '#2A0808',
    btnPrimaryBg: '#8B0000',
    btnPrimaryText: '#FFF3C4',
    navBg: 'rgba(251, 248, 242, 0.94)',
    navBorder: 'rgba(212, 175, 55, 0.3)',
    navActive: '#8B0000',
    navInactive: 'rgba(42, 8, 8, 0.45)',
    floatingBtnBg: 'rgba(255, 255, 255, 0.95)',
    floatingBtnBorder: 'rgba(212, 175, 55, 0.4)',
    floatingBtnText: '#8B0000',
    floatingBtnRing: 'rgba(139, 0, 0, 0.25)',
    floatingBtnActiveText: '#D4AF37',
  },

  // ⚡ Cyberpunk 2077 / Neo-Jakarta (Neon Cyan, Magenta & Deep Night Matrix)
  cyberpunk: {
    isDark: true,
    bg: '#0A0A12',
    cardBg: 'rgba(15, 16, 32, 0.92)',
    ...
    secondary: '#FF007F',
    accent: '#FFE600',
    inputBg: 'rgba(10, 10, 18, 0.9)',
    inputBorder: 'rgba(0, 240, 255, 0.4)',
    inputText: '#00F0FF',
    btnPrimaryBg: '#00F0FF',
    btnPrimaryText: '#0A0A12',
    navBg: 'rgba(10, 10, 18, 0.95)',
    navBorder: 'rgba(0, 240, 255, 0.3)',
    navActive: '#00F0FF',
    navInactive: 'rgba(240, 246, 252, 0.45)',
    floatingBtnBg: 'rgba(15, 16, 32, 0.95)',
    floatingBtnBorder: 'rgba(0, 240, 255, 0.4)',
    floatingBtnText: '#00F0FF',
    floatingBtnRing: 'rgba(0, 240, 255, 0.3)',
    floatingBtnActiveText: '#FF007F',
  },
};
